...
<body>
	...
	<div class="container margin100">
		<form action="UpdateNotes?note_id=<%= note.getNoteId() %>" method="POST">
			<div class="form-group">
				<label>Note Title</label> <input
					type="text" name="title" required class="form-control" id="title"
					aria-describedby="emailHelp" value="<%= note.getNoteTitle() %>"
					class="form-control">
			</div>
			<div class="form-group">
				<label>Notes Description</label><br />
				<textarea required name ="content" id="content" style="height: 400px;" placeholder="Enter Descrepetions"
					class="form-control" id=""><%= note.getNoteInstruction()%>
					</textarea>
			</div>
